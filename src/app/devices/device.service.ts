...
export class DeviceService {
  ...
  createForm(model?: DeviceViewModel): FormGroup {
    return new FormGroup({
      ...
      jadid: new FormControl(model?.name, [
        Validators.required,
  ...
  ): Observable<{ data: DeviceListViewModel[]; dataSize: number }> {
    this.loadingList.next(true);
    return this.http
      .post<{ data: DeviceListViewModel[]; dataSize: number }>(
